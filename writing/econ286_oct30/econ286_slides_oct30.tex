...
\begin{frame}{College attainment in the West in differences}
  \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/state_college_attainment_regression_coefficients.png"}
    \end{figure}
\end{frame}

\begin{frame}{Wages over regions and cohorts}
  \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/state_income_by_cohort_region.png"}
  \end{figure}
\end{frame}

\begin{frame}{The earnings of increasingly younger cohorts across regions has converged}
  \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/state_income_regression_coefficients_log.png"}
  \end{figure}
\end{frame}
...
\begin{frame}{Zero cost colleges across space}
  \begin{figure}
        \centering
...
\item Individuals below age 18 at the time of a college founding are \textbf{4-8\% more likely to attend college} compared to those above age 18
\end{wideitemize}
\end{frame}
...
\begin{frame}[label=next_steps]{Next steps}
  ...
  \item \textbf{Model}
  \begin{enumerate}
    \item Write down a two-stage model where individuals (1) invest in education then (2) migrate for work. College expansions decrease the cost of education.
  \end{enumerate}
\end{enumerate}
\end{frame}
