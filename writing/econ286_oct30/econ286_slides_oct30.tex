...
\title[]{How the Dawn of Public Higher Education Shaped Access and Work}
...
\begin{wideitemize}
    \item How did the founding of public colleges change access to college?
...
\begin{transitionframe}
  \begin{center}
    {\Large \textcolor{white}{Trends in college attendance}}
  \end{center}
\end{transitionframe}
...
\begin{frame}{BA Completion Maps}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/ba_completion_maps.png"}
        \caption{Geographic Distribution of BA Completion}
    \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/col_attainment_funding_quadrants1936.png"}
  \end{figure}
\end{frame}


\begin{frame}{College Enrollment Changes by State}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/enrollments_bowman_1962.png"}
        \caption{College Enrollments from Bowman (1962)}
    \end{figure}
\end{frame}

\begin{transitionframe}
  \begin{center}
    {\Large \textcolor{white}{Who goes to public versus private higher ed?}}
  \end{center}
\end{transitionframe}

\begin{frame}{Parent Occupations}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/parent_occ_bowman_1962.png"}
        \caption{Parent Occupations from Bowman (1962)}
    \end{figure}
\end{frame}
...
\begin{transitionframe}
  \begin{center}
    {\Large \textcolor{white}{Founding year of colleges}}
  \end{center}
\end{transitionframe}
...
\begin{frame}{College Founding Years}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/founding_years_cdf.png"}
...
\begin{frame}{College Founding Years (1800+)}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/founding_years_cdf_1800_plus.png"}
...
\begin{frame}{College Founding Years by Region (1800+)}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{"/Users/cjwardius/Library/CloudStorage/OneDrive-UCSanDiego/demo of education/output/figures/founding_years_cdf_regional_1800_plus.png"}
