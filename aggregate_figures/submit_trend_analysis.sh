...
#SBATCH --output=trend_college_%j.log
#SBATCH --error=trend_college_%j.err
...
OUTPUT_DIR="/home/cwardius/output/figures"
...
echo "========================================================================"
echo "Command: python trend_college_attainment.py $INPUT_DATA $OUTPUT_DIR"
echo ""

python trend_college_attainment.py "$INPUT_DATA" --output "$OUTPUT_DIR"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "SUCCESS: Trend analysis completed successfully"
else
