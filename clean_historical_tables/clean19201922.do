...
import delimited "data/extracted_scans/bi_survey1920_1922_extracted", clear
...
keep if inrange(page_number, 1,24) | inrange(page_number, 33,85)
...
export delimited "data/cleaned_scans/bi_survey1920_1922.csv", replace
